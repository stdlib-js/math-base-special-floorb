...
<!-- <equation class="equation" label="eq:floorb_function" align="center" raw="y = \left\lfloor \frac{x}{b^n} \right\rfloor \cdot b^n" alt="Round down to nearest multiple of b^n"> -->

```math
y = \left\lfloor \frac{x}{b^n} \right\rfloor \cdot b^n
```

<!-- <div class="equation" align="center" data-raw-text="y = \left\lfloor \frac{x}{b^n} \right\rfloor \cdot b^n" data-equation="eq:floorb_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/floorb/docs/img/equation_floorb_function.svg" alt="Round down to nearest multiple of b^n">
    <br>
</div> -->
