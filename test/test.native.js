...
var floorb = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( floorb instanceof Error )
};
...
tape( 'if `n = 0`, the function exhibits standard floor behavior', opts, function test( t ) {
	var x;
	var v;
	var i;
...
tape( 'if `b = 1`, the function exhibits standard floor behavior', opts, function test( t ) {
	var x;
	var v;
	var i;
